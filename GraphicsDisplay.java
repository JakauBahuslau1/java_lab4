package bsu.rfe.java.group8.lab4.Leonenko.varA11;
...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10.0f, new float[] {5, 5, 10, 5, 5, 5, 20, 5, 10, 5, 5, 5}, 1.0f);
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minY <= 0.0 && maxY >= 0.0) {
            ...
            //canvas.drawLine(100, 100, 100, -100);
            canvas.drawLine((int) labelPos3.getX(), (int) labelPos3.getY()+10, (int) labelPos3.getX(), (int) labelPos3.getY()-10);
